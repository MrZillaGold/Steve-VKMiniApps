                ...
                <Online>
                    <FormLayout>
                        <Input
                            ...
                            status={this.state.ip.match(/[а-яА-ЯёЁa-zA-Z0-9]+(\.[а-яА-ЯёЁa-zA-Z0-9]+)+[.:0-9]*/g) || this.state.ip === "" ? 'default' : 'error'}
                            bottom={this.state.ip.match(/[а-яА-ЯёЁa-zA-Z0-9]+(\.[а-яА-ЯёЁa-zA-Z0-9]+)+[.:0-9]*/g) || this.state.ip === "" ? 'Например: Hypixel.net' : 'Неправильный IP-Адрес'}
                            placeholder="Введите IP-Адрес"
                            pattern='[а-яА-ЯёЁa-zA-Z0-9]+(\.[а-яА-ЯёЁa-zA-Z0-9]+)+[.:0-9]*'
                            maxLength='100'
                        />
                        {
                            this.state.ip.length > 2 && this.state.spinner === null && this.state.ip.match(/[а-яА-ЯёЁa-zA-Z0-9]+(\.[а-яА-ЯёЁa-zA-Z0-9]+)+[.:0-9]*/g) ?
