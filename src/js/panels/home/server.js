                ...
                <Online>
                    <FormLayout>
                        <Input
                            ...
                            status={this.state.ip.match(/(?:(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/g) || this.state.ip.match(/(?:(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?):(1|2|3|4|5|6|7|8|9)([0-9]{1,5})$/g) || this.state.ip.match(/^([а-яА-ЯёЁa-z0-9]+(-[а-яА-ЯёЁa-z0-9]+)*\.)+[а-яА-ЯёЁa-z]{2,}:(1|2|3|4|5|6|7|8|9)([0-9]{1,5})$/g) || this.state.ip.match(/^([а-яА-ЯёЁa-z0-9]+(-[а-яА-ЯёЁa-z0-9]+)*\.)+[а-яА-ЯёЁa-z]{2,}$/g) || this.state.ip === "" ? 'default' : 'error'}
                            bottom={this.state.ip.match(/(?:(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/g) || this.state.ip.match(/(?:(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?):(1|2|3|4|5|6|7|8|9)([0-9]{1,5})$/g) || this.state.ip.match(/^([а-яА-ЯёЁa-z0-9]+(-[а-яА-ЯёЁa-z0-9]+)*\.)+[а-яА-ЯёЁa-z]{2,}:(1|2|3|4|5|6|7|8|9)([0-9]{1,5})$/g) || this.state.ip.match(/^([а-яА-ЯёЁa-z0-9]+(-[а-яА-ЯёЁa-z0-9]+)*\.)+[а-яА-ЯёЁa-z]{2,}$/g) || this.state.ip === "" ? 'Например: Hypixel.net' : 'Неправильный IP-Адрес.'}
                            placeholder="Введите IP-Адрес"
                            pattern='[а-яА-ЯёЁa-zA-Z0-9]+(\.[а-яА-ЯёЁa-zA-Z0-9]+)+[.:0-9]*'
                            maxLength='100'
                        />
                        {
                            this.state.ip.length > 2 && this.state.spinner === null && (this.state.ip.match(/(?:(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$/g) || this.state.ip.match(/(?:(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?):(1|2|3|4|5|6|7|8|9)([0-9]{1,5})$/g) || this.state.ip.match(/^([а-яА-ЯёЁa-z0-9]+(-[а-яА-ЯёЁa-z0-9]+)*\.)+[а-яА-ЯёЁa-z]{2,}:(1|2|3|4|5|6|7|8|9)([0-9]{1,5})$/g) || this.state.ip.match(/^([а-яА-ЯёЁa-z0-9]+(-[а-яА-ЯёЁa-z0-9]+)*\.)+[а-яА-ЯёЁa-z]{2,}$/g)) ?
