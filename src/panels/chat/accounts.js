...
class Accounts extends React.Component {
    ...
    async componentDidMount() {
        ...
        await VKConnect.send("VKWebAppStorageGet", {keys: ["chatAccountsList", "chatSelectedAccount"]})
            .then(res => {
    ...
    async selectAccount(account) {
        ...
        await VKConnect.send("VKWebAppStorageSet", {key: "chatSelectedAccount", value: JSON.stringify(account)});
    }

    async saveAccountsEdits() {
        sessionStorage.setItem('chatAccounts', JSON.stringify(this.state.accounts));

        await VKConnect.send("VKWebAppStorageSet", {key: "chatAccountsList", value: JSON.stringify(this.state.accounts)});
    ...
    addAccount = (data) => {
        ...
        VKConnect.send("VKWebAppStorageSet", {key: "chatAccountsList", value: JSON.stringify(accountslist)});
    };
