...
class Servers extends React.Component {
    ...
    render() {
        const {navigator, connect, editTab, visible} = this.props;
                                ...
                                this.state.servers.map((server, index) => (
                                    this.state.editList ?
                                        ...
                                        <Cell key={index}
                                              ...
                                              size="l"
                                              asideContent={
                                                  <Tappable onClick={() => navigator.showModal("edit-server", {server: server, index: index, servers: this.state.servers, editServer})}>
                                                      <Icon28EditOutline height={24} width={24} />
                                                  </Tappable>
                                              }
                                              bottomContent={
                                                  <Tappable onClick={() => this.state.selectedAccount ? connect(server, this.state.selectedAccount, navigator) : editTab("accounts")}>
                                                     Зайти на сервер
                                                  </Tappable>
                                              }
                                              description={server.version}>
